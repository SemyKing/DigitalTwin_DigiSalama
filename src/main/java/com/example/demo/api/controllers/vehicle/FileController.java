...
public class FileController {
	...
	public String put(@ModelAttribute FileDB fileDB, Model model) {
		String oldFileFromDatabase = fileService.getById(fileDB.getId()).toString();

		fileDB = new FieldReflectionUtils<FileDB>().getEntityWithEmptyStringValuesAsNull(fileDB);
